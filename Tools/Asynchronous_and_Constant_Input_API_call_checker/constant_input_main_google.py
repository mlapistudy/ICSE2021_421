...
KEYWORD1 = "synthesize_speech"
# Keyword name if input is passed-in by keyword -- In Google TTS, this is "input"
KEYWORD2 = "input"
...
if __name__ == "__main__":
    for line in infd.readlines():
        try:
            ...
            url_list = search_github(KEYWORD1, repo, ofd)
